		...
		bind : function () {
			...
			this.element
				...
				.on("dblclick.jstree", ".jstree-anchor", $.proxy(function (e) {
					...
					var targetElement = $(this)[0].element;
					var dptNameNum = $(this)[0].element.attr('aria-activedescendant');
					var exDptName = targetElement.find('ul').children('li#'+dptNameNum).find('a').first().text();
					//var exDptName = targetElement.find($dptNameNum);
				
								
          //alert(exDptName);

					$('#ex-dpt-name').attr('placeholder', exDptName);
					$('#new-dpt-name').val('');
					$('.user-update-modal-background').addClass('active');
