$(function () {
  ...
  $(document).on(
    "click",
    "li[id^=my-drive] i.arrow, li[id^=share-drive] i.arrow, li[id^=parent] i.arrow",
    function () {
  ...
  $(document).on(
    "click",
    "ul[id^=drive-list] li button, li[id^=my-drive] i:nth-child(2), li[id^=share-drive] i:nth-child(2)",
    function () {
  ...
  $(document).on(
    "contextmenu",
    ".my-drive-table tr, .my-drive-list li, #my-drive li, #share-drive ul li ul li,.share-drive-list.folder-list li",
    function (e) {
      var x = e.pageX + 30;
      var y = e.pageY - 250;
      $("#folder-menu1").css("top", y + "px");
      $("#folder-menu1").css("left", x + "px");
      $("#folder-menu1").show();
      return false;
    }
  );
  ...
  $(document).on(
    "contextmenu",
    ".share-drive-list.file-list li, .gallery-btm.share ul li",
    function (e) {
      var x = e.pageX - 0;
      var y = e.pageY - 250;
      $("#folder-menu2").css("top", y + "px");
      $("#folder-menu2").css("left", x + "px");
      $("#folder-menu2").show();
      return false;
    }
  );
  ...
  $(document).on("contextmenu", ".user-item", function (e) {
    ...
    var oWidth = $(".share-user-modal").width();
    var oHeight = $(".share-user-modal").height();
    ...
    // 레이어 위치를 바꾸었더니 상단기준점(0,0) 밖으로 벗어나면 상단기준점(0,0)에 배치
    if (x < 0) x = 10;
    if (y < 0) y = 0;
  ...
  $(document).on("contextmenu", "#my-drive", function (e) {
    ...
    $("#folder-menu3").css("left", x + "px");
    $("#folder-menu3").css("top", y + 130 + "px");
    $("#folder-menu3").show();
    return false;
  });
  ...
  $(document).on("contextmenu", "#share-drive", function (e) {
    ...
    $("#folder-menu4").css("left", x + "px");
    $("#folder-menu4").css("top", y + "px");
    $("#folder-menu4").show();
    return false;
  });
  ...
  $(document).on("contextmenu", "#share-drive>ul>li", function (e) {
    ...
    $("#folder-menu5").css("top", y + "px");
    $("#folder-menu5").css("left", x + "px");
    $("#folder-menu5").show();
    return false;
  });
  ...
  $("body").on("click", function (e) {
    var exceptArea = $(e.target).parents("#rmenu, ul[id^=folder-menu]").length;
    if (exceptArea == 0) {
      $("#rmenu, ul[id^=folder-menu]").hide();
    }
  });
  $("body").on("click", function (e) {
...
$(document).on("click", ".alert-min-btn", function () {
  // $(this).css('transform',('rotate(0.5turn)'));
  $(".upload-popup-box").css("height", "66px").css("overflow", "inherit");
  $(".top-down").css("display", "flex");
